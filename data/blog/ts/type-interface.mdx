...
draft: false
summary: '이전에 진행했던 프로젝트의 기획단계에서 "기왕하는거 타입스크립트 쓰자!"라고 말했던 바보 멍청이는 프로젝트 내내 any를 난사하여 작성하였고, 이제는 프로젝트 코드 대부분을 변경해야하는 대공사를 시작하려한다.'
...
- `interface`는 **기존의 class처럼 extends**를 통해 확장함
